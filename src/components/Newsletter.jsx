...
function Newsletter() {
  return (
    <div className='flex justify-center items-center h-[350px] w-[100%] flex-col bg-[#6ec0f7]'>
        ...
        border-[#cccccc] rounded-[5px] overflow-hidden mobile:min-w-[20rem]'>
            <input 
                type="email" 
                placeholder='email'
                className='border-none pl-[20px] flex-[7] outline-none'
            />
            <button className='bg-[#10964c] flex-1 h-[100%]'>
